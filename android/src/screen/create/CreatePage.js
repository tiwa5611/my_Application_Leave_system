...
import {Text, StatusBar, TextInput, View, StyleSheet, TouchableOpacity, ImageBackground, Image, Dimensions} from 'react-native';
...
class CreatePage extends Component {
  ...
  componentDidMount(){
    console.log('componentDidMount create Page: edit', this.props.navigation.state.params )
    if (this.props.navigation.state.params != null) {
      ...
      global.status_tap = true
    }
  }

  render() {    
      console.log('selectIndex: ',this.state.selectedIndex);
      console.log('selectIndexPeriod : ', this.state.selectedIndexPeriod);
      console.log('status_taps:', status_tap)
                ...
                <Card style={styles.cardStyle}>
                  {/* Leave type */}
                    <View style={{marginTop:10,}}>
                        ...
                        />
                        {/* {console.log('Leave_type: ', this.state.leave_type)} */}
                    </View>
                    ...
                    <View>
                      <ButtonGroup
                        ...
                        containerStyle={{height: 50, borderRadius:10, height:40, borderColor:'gray'}}
                      />
                      {/* {console.log('Period: ', this.state.leave_period)} */}
                    </View>
                    {/* <LeaveReason/> */}
  ...
  hadleSubmit = async () => {
    try {
      ...
      console.log('token in button submit: ', token_value.token);
...
export default CreateScreen = createAppContainer(createStackNavigator({
  ...
  defaultNavigationOptions: ({ navigation }) => {
    const { status_edit } = this.state
    return {
      headerTransparent:true,
      headerLeft:
      
      // <TouchableOpacity style={{marginTop:40, marginLeft:20 ,marginBottom:10}} onPress={() => navigation.goBack()}>
      ...
      // //     onPress={ () => navigation.openDrawer() } navigation.navigate('Dashboard')
      // //   />
      // // </TouchableOpacity>
      // :
      <TouchableOpacity style={{marginTop:30, marginLeft:15 ,marginBottom:10}}>
        {console.log('TopBar :', status_edit)}
        <Icon name="bars" size={30} color={'white'} style={{marginTop:15}}
